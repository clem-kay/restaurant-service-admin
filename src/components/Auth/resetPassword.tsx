        ...
        resetPassword({resetPasswordData: values as UserAccountPasswordResetData},
            {
                ...
                onError: (error) => {
                    toast.success("Could not reset Password")
                    handleError(error)
                }
            }
        )
    ...
    return (
        <>
            ...
            <div
                ...
                <p className="text-sm max-w-sm mt-2">Reset Password</p>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="my-8">
                    ...
                    <LabelInputContainer className="mb-4">
                        ...
                        <Input id="oldPassword" placeholder="••••••••••"
                               type="password" {...form.register("oldPassword")} />
                        {form.formState.errors.oldPassword &&
                            <p className="text-destructive">{form.formState.errors.oldPassword.message}</p>}
                    </LabelInputContainer>
                    ...
                    <LabelInputContainer className="mb-4">
                        ...
                        <Input id="oldPassword" placeholder="••••••••••"
                               type="password" {...form.register("newPassword")} />
                        {form.formState.errors.newPassword &&
                            <p className="text-destructive">{form.formState.errors.newPassword.message}</p>}
                    </LabelInputContainer>
